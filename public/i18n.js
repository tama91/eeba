...
en: {
  ...
  reg: {
    ...
    f:{ fn:"First name", ln:"Last name", em:"Email", em2:"Confirm email", org:"Institution / Company",
        ...
        meal:"Meal preference", mealHint:"So the caterer knows how many of each to prepare.", mealPick:"Choose a menu",
        allerg:"Allergies or intolerances", allergHint:"Only if you have any. Be specific — the kitchen needs to know exactly what to avoid.",
        allergConsent:"I agree that this information, which concerns my health, is shared with the caterer for the meals at this meeting and deleted afterwards.", allergNeeded:"Please confirm the consent below to share your allergy information.",
    ...
    pay:{ redirect:"You'll be taken to a secure payment page.",
          offlineNote:"Your registration is recorded straight away and confirmed once payment arrives.",
          preview:"Preview mode — no real payment is taken.",
          processing:"Completing your payment…",
          okT:"Payment received.",
          okP:"Your place is confirmed. The confirmation and invoice are on their way to your inbox.",
          failT:"Payment not completed.",
          failP:"Nothing has been charged. Your registration is saved — you can try again or choose another method.",
          retry:"Try again",
          pending:"Awaiting payment" },
    pm:{ card:"Credit / debit card", sepa:"SEPA bank transfer", inv:"Institutional invoice", bancontact:"Bancontact", ideal:"iDEAL", paypal:"PayPal", revolut_pay:"Revolut Pay" },
...
it: {
  ...
  reg: {
    ...
    f:{ fn:"Nome", ln:"Cognome", em:"Email", em2:"Conferma email", org:"Ente / Azienda",
        ...
        meal:"Preferenza per i pasti", mealHint:"Serve al catering per sapere quanti piatti preparare di ciascun tipo.", mealPick:"Scegli un menu",
        allerg:"Allergie o intolleranze", allergHint:"Solo se ne hai. Sii preciso: la cucina deve sapere esattamente cosa evitare.",
        allergConsent:"Acconsento che questa informazione, che riguarda la mia salute, sia comunicata al servizio di ristorazione per i pasti di questo congresso e cancellata al termine.", allergNeeded:"Conferma il consenso qui sotto per comunicare le tue allergie.",
    ...
    pay:{ redirect:"Verrai portato su una pagina di pagamento sicura.",
          offlineNote:"L'iscrizione viene registrata subito e confermata quando il pagamento arriva.",
          preview:"Modalità anteprima — nessun pagamento reale viene addebitato.",
          processing:"Sto completando il pagamento…",
          okT:"Pagamento ricevuto.",
          okP:"Il tuo posto è confermato. Conferma e fattura stanno arrivando nella tua casella.",
          failT:"Pagamento non completato.",
          failP:"Non è stato addebitato nulla. L'iscrizione è salvata: puoi riprovare o scegliere un altro metodo.",
          retry:"Riprova",
          pending:"In attesa di pagamento" },
    pm:{ card:"Carta di credito / debito", sepa:"Bonifico SEPA", inv:"Fattura istituzionale", bancontact:"Bancontact", ideal:"iDEAL", paypal:"PayPal", revolut_pay:"Revolut Pay" },
...
nl: {
  ...
  reg: {
    ...
    f:{ fn:"Voornaam", ln:"Achternaam", em:"E-mail", em2:"Bevestig e-mail", org:"Instelling / Bedrijf",
        ...
        meal:"Maaltijdvoorkeur", mealHint:"Zo weet de cateraar hoeveel er van elk moet worden bereid.", mealPick:"Kies een menu",
        allerg:"Allergieën of intoleranties", allergHint:"Alleen als u die heeft. Wees precies: de keuken moet exact weten wat te vermijden.",
        allergConsent:"Ik ga ermee akkoord dat deze informatie, die mijn gezondheid betreft, met de cateraar wordt gedeeld voor de maaltijden tijdens deze vergadering en daarna wordt gewist.", allergNeeded:"Bevestig hieronder uw toestemming om uw allergie-informatie te delen.",
    ...
    pay:{ redirect:"U wordt naar een beveiligde betaalpagina gebracht.",
          offlineNote:"Uw inschrijving wordt meteen vastgelegd en bevestigd zodra de betaling binnen is.",
          preview:"Voorbeeldmodus — er wordt niets echt afgeschreven.",
          processing:"Bezig met afronden van de betaling…",
          okT:"Betaling ontvangen.",
          okP:"Uw plaats is bevestigd. Bevestiging en factuur zijn onderweg naar uw mailbox.",
          failT:"Betaling niet afgerond.",
          failP:"Er is niets afgeschreven. Uw inschrijving is bewaard: probeer opnieuw of kies een andere methode.",
          retry:"Opnieuw proberen",
          pending:"Wacht op betaling" },
    pm:{ card:"Krediet- / debetkaart", sepa:"SEPA-overschrijving", inv:"Institutionele factuur", bancontact:"Bancontact", ideal:"iDEAL", paypal:"PayPal", revolut_pay:"Revolut Pay" },
...
fr: {
  ...
  reg: {
    ...
    f:{ fn:"Prénom", ln:"Nom", em:"E-mail", em2:"Confirmer l'e-mail", org:"Établissement / Entreprise",
        ...
        meal:"Préférence de repas", mealHint:"Le traiteur saura ainsi combien de plats préparer de chaque sorte.", mealPick:"Choisissez un menu",
        allerg:"Allergies ou intolérances", allergHint:"Uniquement si vous en avez. Soyez précis : la cuisine doit savoir exactement quoi éviter.",
        allergConsent:"J'accepte que cette information, qui concerne ma santé, soit communiquée au traiteur pour les repas de ce congrès et supprimée ensuite.", allergNeeded:"Confirmez le consentement ci-dessous pour communiquer vos allergies.",
    ...
    pay:{ redirect:"Vous serez dirigé vers une page de paiement sécurisée.",
          offlineNote:"L'inscription est enregistrée immédiatement et confirmée dès réception du paiement.",
          preview:"Mode aperçu — aucun paiement réel n'est prélevé.",
          processing:"Finalisation du paiement…",
          okT:"Paiement reçu.",
          okP:"Votre place est confirmée. La confirmation et la facture arrivent dans votre boîte mail.",
          failT:"Paiement non abouti.",
          failP:"Rien n'a été prélevé. Votre inscription est enregistrée : réessayez ou choisissez un autre moyen.",
          retry:"Réessayer",
          pending:"En attente de paiement" },
    pm:{ card:"Carte bancaire", sepa:"Virement SEPA", inv:"Facture institutionnelle", bancontact:"Bancontact", ideal:"iDEAL", paypal:"PayPal", revolut_pay:"Revolut Pay" },
